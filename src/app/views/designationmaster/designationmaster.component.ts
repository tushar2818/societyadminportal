...
export class DesignationMasterComponent {
  ...
  uniqueKey: any = "DesignationMasterID";
  pageTitleKey: any = "PageTitles.DesignationMaster";

  //constructor 
  constructor(
    private service: DesignationMasterService,
  ...
  ngOnInit() {
    try {
      this.modelHeaders = ["TableHeaders.DesignationKey", "TableHeaders.DesignationValue", "TableHeaders.DesignationHin", "TableHeaders.DesignationMar"];
