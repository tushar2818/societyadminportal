...
@Component({
  templateUrl: 'flattypemaster.component.html'
})

export class FlatTypeMasterComponent {
  ...
  uniqueKey: any = "FlatTypeMasterID";
  pageTitleKey: any = "PageTitles.FlatTypeMaster";
  ...
  ngOnInit() {
    try {
      this.modelHeaders = ["TableHeaders.FlatType"];
