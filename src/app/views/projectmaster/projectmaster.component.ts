...
export class ProjectMasterComponent {
  ...
  uniqueKey: any = "ProjectMasterID";
  pageTitleKey: any = "PageTitles.ProjectMaster";

  //constructor 
  constructor(
    private service: ProjectMasterService,
  ...
  ngOnInit() {
    try {
      this.modelHeaders = ["TableHeaders.ProjectName", "TableHeaders.Address"];
      this.refresh();
    } catch (e) {
