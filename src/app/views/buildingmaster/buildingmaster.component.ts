...
@Component({
  templateUrl: 'buildingmaster.component.html'
})

export class BuildingMasterComponent {
  ...
  uniqueKey: any = "BuildingMasterID";
  pageTitleKey: any = "PageTitles.BuildingMaster";

  //constructor 
  constructor(
    private service: BuildingMasterService,
  ...
  ngOnInit() {
    try {
      this.modelHeaders = ["TableHeaders.BuildingName"];
      this.refresh();
    } catch (e) {
